...
| Challenge artwork | `challenge_visual_registry.dart` | Unrelated generic UI images used for several challenges | Unclear presentation | Exact unique PNG request per challenge, with unique non-image fallback | Manifest and registry audit |
