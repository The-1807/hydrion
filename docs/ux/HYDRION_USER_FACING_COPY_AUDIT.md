...
| Challenge artwork | `challenge_visual_registry.dart` | Unrelated generic UI images used for eight newer challenges | Unclear presentation | Preserve six owner-supplied images; request unique PNGs only for eight missing images | Manifest and registry audit |
