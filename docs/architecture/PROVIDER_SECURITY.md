...
2. `HydrationAiActionExecutionService` requires user confirmation for
   state-changing actions.
3. The executor writes only through Hydrion repositories/services.
4. Providers never write hydration logs, reminders, challenges, settings,
