...
void main() {
  ...
  testWidgets('app shell swaps to fake domain adapters without UI changes',
    ...
    final services = HydrionServices(
      ...
      appLocaleRepository: base.appLocaleRepository,
      ...
      dailyHydrationContextRepository: base.dailyHydrationContextRepository,
      personalizationStateRepository: base.personalizationStateRepository,
      ...
      timedSessionNotificationService: base.timedSessionNotificationService,
      ...
      dailyHydrationRecommendationCoordinator:
          base.dailyHydrationRecommendationCoordinator,
      challengeRecommendationService: base.challengeRecommendationService,
